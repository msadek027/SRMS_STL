    ...
    public class ProductPriceDAO : ReturnData
    {
        ...
        public IList<ProductPriceBEL> GetAllInfo(ProductPriceBEL model, string orderBy)
        {
            ...
            try
            {
                ...
                // ADDED: Unit Code and Name selection
                query.Append(" TO_CHAR(D.SET_ON, 'dd/mm/yyyy')SET_ON,P.PRODUCT_CODE,PR.DAR_NO,CU.COMPANY_UNIT_NAME,R.COMPANY_CODE AS COMPANY_UNIT_CODE,");

                // REMOVED: DF.DOSAGE_FORM_NAME
                query.Append(" C.COMPANY_CODE,C.COMPANY_NAME,C.LICENSE_NO,P.SAP_PRODUCT_CODE,P.GENERIC_CODE,P.BRAND_NAME,P.PACK_SIZE_NAME");

                query.Append(" FROM PRODUCT_PRICE D");
                query.Append(" LEFT JOIN  PRODUCT_REGISTRATION_INFO PR ON PR.ANNEX_ID=D.ANNEX_ID");
                query.Append(" LEFT JOIN  RECIPE_INFO R ON R.ID=PR.RECIPE_ID");

                // ADDED: Unit and Company Link
        ...
        public IList<ProductRegistrationBEL> GetAllProductFromAnnex(string orderBy)
        {
            ...
            // ADDED: R.COMPANY_CODE as Unit Code and CU.COMPANY_UNIT_NAME
            ...
            // ADDED: Joins for Unit Info and Company Info
            query.Append(" LEFT JOIN  COMPANY_UNIT_INFO CU ON R.COMPANY_CODE = CU.COMPANY_UNIT_CODE");
            query.Append(" LEFT JOIN  COMPANY_INFO C ON CU.COMPANY_CODE = C.COMPANY_CODE");
