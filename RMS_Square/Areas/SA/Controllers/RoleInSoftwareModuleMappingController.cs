...
using RMS_Square.Areas.SA.Models.DAL;
...
{
    public class RoleInSoftwareModuleMappingController : ControllerController
    {
        ...
        {
            var model = GetRoleInSoftwareModuleMapping(RoleID);
